...
argument instead of a spanless codegen refusal. Only a path-call
with no row at all — or a row whose parameter is deliberately
polymorphic, like the user `@form(vec)` destination of
