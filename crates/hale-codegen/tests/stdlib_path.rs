...
//!
//! Hale resolves `std::*` paths via a hardcoded namespace
...
//! sign-extended to Hale Int. If this file passes, the same
...
fn std_process_pid_matches_runtime_pid() {
    // Cross-check Hale's std::process::pid() against the actual
