...
think in Hale), this page is for *looking up* what the
...
- [`spec/grammar.ebnf`](https://github.com/hale-lang/hale/blob/main/spec/grammar.ebnf) —
  ...
  parser accepts.
- [`spec/tokens.md`](https://github.com/hale-lang/hale/blob/main/spec/tokens.md) —
...
- [`spec/precedence.md`](https://github.com/hale-lang/hale/blob/main/spec/precedence.md) —
  expression precedence and associativity table.

## Semantics

- [`spec/semantics.md`](https://github.com/hale-lang/hale/blob/main/spec/semantics.md) —
...
- [`spec/types.md`](https://github.com/hale-lang/hale/blob/main/spec/types.md) —
...
- [`spec/memory.md`](https://github.com/hale-lang/hale/blob/main/spec/memory.md) —
...
- [`spec/projects.md`](https://github.com/hale-lang/hale/blob/main/spec/projects.md) —
  project layout, per-directory seed model (F.19), cross-seed
  imports (F.25), workspace fallback, resolution order,
  mangling scheme.
- [`spec/packages.md`](https://github.com/hale-lang/hale/blob/main/spec/packages.md) —
  the v1 package surface. `hale.toml` manifest, `hale.lock`,
  `hale fetch` git-based dependency fetcher.

## Style and conventions

- [`spec/styleguide.md`](https://github.com/hale-lang/hale/blob/main/spec/styleguide.md) —
  idiomatic Hale. The full version of the patterns
  introduced in
...
- [`spec/testing.md`](https://github.com/hale-lang/hale/blob/main/spec/testing.md) —
...
- [`spec/design-rationale.md`](https://github.com/hale-lang/hale/blob/main/spec/design-rationale.md) —
  *why* the language is shaped the way it is. Numbered
  commitments F.0 through F.35 cover every design decision
...
Hale exposes user-extensible `@ffi("c")` declarations. Library
authors ship bindings (`pond/raylib`, `pond/sqlite`, ...)
without compiler changes.

- [Bind a C library](../how-tos/ffi-bindings.md) — minimum
  end-to-end how-to.
- [`spec/ffi.md`](https://github.com/hale-lang/hale/blob/main/spec/ffi.md) —
