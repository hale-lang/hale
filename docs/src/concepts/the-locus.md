...
> What is a locus, and why is *everything* one?

The locus is the single structural primitive Hale gives you.
...
runtime (`self.target_size = 6;` inside a method). Hale
...
locus vs Hale's other declarative primitive, `type`.
...
This rule exists because every other guarantee Hale makes
...
[Modeling — how to think in Hale](./modeling.md) develops
