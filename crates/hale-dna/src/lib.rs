...
pub const HOST_FILES: &[EmbeddedFile] = host!["connections", "forge_github", "genome", "host", "infra", "main", "memory", "nerves", "node", "organization_launch", "procs", "projection", "record", "record_verbs", "show", "verbs", "writers"];
