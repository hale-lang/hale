...
virtual answers with a [lotus](../../reference/book/glossary.html#lotus)
shaped exactly as your spell described.

## What came through

One [locus](../../reference/book/glossary.html#locus). Just one.
...
virtual with it — its
[arena](../../reference/book/glossary.html#arena). The greeting
