...
five-minute [quickstart](../quickstart/introduction.md), the
substrate-up *[Aperio Programming
Language](../book/introduction.md)*, the formal
[reference](../reference/introduction.md). They all teach the same
...
boundary; a running [lotus](../reference/glossary.md#lotus)
...
lotus, a tree of [loci](../reference/glossary.md#locus)
...
book](../book/introduction.md) is across the hall. Same material,
different doorway.
