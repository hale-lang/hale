...
With a webroot, the head loads the nine fixed browser assets once, injects the
...
exact-origin CSP policy; the head does not proxy the observer. Restart the head
after changing assets or configuration.
