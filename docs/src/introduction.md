...
- [`spec/semantics.md`](https://github.com/local/lotus-lang/blob/main/spec/semantics.md) —
  language semantics.
- [`spec/styleguide.md`](https://github.com/local/lotus-lang/blob/main/spec/styleguide.md) —
  idiomatic Aperio.
...
[`crates/aperio-codegen/tests/fixtures/examples/`](https://github.com/local/lotus-lang/tree/main/crates/aperio-codegen/tests/fixtures/examples) —
