...
[`aperio`](../reference/glossary.md#aperio) toolchain — the
...
the boundary, and on the far side a [lotus](../reference/glossary.md#lotus)
will open whose entire being consists of one
[locus](../reference/glossary.md#locus) that prints `hello,
