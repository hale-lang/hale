...
- **Namespace lotus** — `std::cli`, `std::iter`, `std::json`,
  ...
  [`crates/aperio-codegen/runtime/stdlib/*.ap`](https://github.com/aperio-lang/aperio/tree/main/crates/aperio-codegen/runtime/stdlib).
...
[`crates/aperio-codegen/tests/`](https://github.com/aperio-lang/aperio/tree/main/crates/aperio-codegen/tests)
