...
[loci](../reference/glossary.md#locus) communicating along a
...
Each locus owns an
[arena](../reference/glossary.md#arena) — a contiguous
...
When a locus's
[closure](../reference/glossary.md#closure) fails or its
...
- **[chat-fanout](./13-chat-fanout.md)** — the capstone: a
